  ...
  geom_col(width = 0.3) +
    scale_fill_manual(breaks = c("norm", "slightly_increased", "increased"), 
                    ...
                    values = c("norm" = "#8DB6F8", 
                                 ...
                                 "increased" = "#C32113")) +
    labs(x = "Intervention Group", y = "Count") +
  theme(legend.title = element_text("Categories of Edinburgh Postnatal Depression Scale"),
        legend.position = "bottom",
        legend.direction = "vertical",
        panel.background = element_rect(fill = "white"),
        panel.grid.major.y = element_line(colour = "#D8D8D8", linewidth = 0.5))
