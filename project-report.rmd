...
-Plot type changed to a stacked bar charts with the counts of each category of depression score, allowing for proportions of score categories in each group to still be seen and showing the differences in totals between intervention groups.  
...
-Intervention groups caption added, making the x-axis less clustered 
...
# Plot graph
figure_4_original <- ggplot(psych_summary, 
...
# Advanced graph
figure_4_improved <- ggplot(psych_summary,
